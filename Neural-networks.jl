...
# ╔═╡ d817eb64-5e31-4875-9279-98e7ef6c6d7a
begin
	using LinearAlgebra
	using Base
	using OffsetArrays
...
# ╔═╡ c2148a47-1b05-4bfa-a10f-f9ee3b6f1ae2
md"""
1. Multilayer perceptron
"""

# ╔═╡ c87a51b3-053f-43d8-80b5-5ac5d250cac2
...
# ╔═╡ a6723a27-1e28-4d0b-9cd6-9870f599900d
...
# ╔═╡ ef08705b-dea1-4b85-95cb-b67fee80c4d6
function sigmoid(x)
	return 1.0 / (1.0 + exp(-x))
end

# ╔═╡ 01bd8867-76ee-4b60-8abb-0da1865c1564
function sigmoidPrime(x)
	return sigmoid(x) * (1.0 - sigmoid(x))
end

# ╔═╡ 0c085da2-1204-41df-b482-c39eb84aecf1
function squaredError(u, v)
	return norm(u - v)
end

# ╔═╡ 60600488-c315-4628-8d21-187c9abb50e1
...
# ╔═╡ b88e785f-2cb6-4421-8381-1284ae28db67
...
# ╔═╡ e2e992c1-1095-42e2-b88c-6959e38bbd5c
...
# ╔═╡ b7a26b15-449e-424c-b946-effef0ea2e04
...
# ╔═╡ c0862db6-b1ae-494a-b1dd-0c5f9c540e3f
...
# ╔═╡ 7feb0831-f5c9-48f2-8007-d1c7db9dffdd
...
# ╔═╡ b4ec423b-7c69-49e7-89e1-93a42816cb70
md"""
2. MNIST dataset
"""

# ╔═╡ 69cce8a7-f420-4255-be86-d1b083a4bc43
begin
...
# ╔═╡ 9a7235b3-2b08-452b-ac94-dddca738d00b
begin
    perceptron = Perceptron([784, 30, 10])

    println("Starts the backpropagation")
    results = SGD(perceptron, trainData, 30, 10, 3.0, testData)
    println("End of the backpropagation")
end

# ╔═╡ 06a94df9-0629-4731-8536-866bc860a33b
plot(results)

# ╔═╡ 94586062-f599-4e35-8101-e4e7caf601e5
[((Gray).(test_x[i]), argmax(feedForward(perceptron, testData[i][1]))-1, argmax(test_y[i])-1) for i in 1:15]
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "2f7b45e6254b3d8dd7a40b68face2296e0ecb30a"
